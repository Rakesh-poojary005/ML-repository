...
win = Tk()
win.title("Emotion Based Player")
...
Label(f, text="Emotion Based Music Player", font=fnt1).grid(row=1, column=2)
Label(f, image=img).grid(row=2, column=2)

fnt2 = font.Font(family='Helvectica', size=10, weight='bold')
b1 = Button(f, text="Start Emotion Player", fg="#31dbcd", bg="#313a39", font=fnt2)
